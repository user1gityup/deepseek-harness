/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-quota-codex`.
 * @module @deepseek-ai/dsh-quota-codex/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-quota-codex'

/** Cordis companion plugin name. */
export const name = 'quota-codex-invariant'
