...
```powershell
Copy-Item -Recurse "C:\Users\ndi2\Documents\Harness Build\ui-openrouter-monitor" `
  "C:\Users\ndi2\Documents\claudecode\deepseek-harness\packages\client\ui-openrouter-monitor"
```
...
```powershell
cd C:\Users\ndi2\Documents\claudecode\deepseek-harness
pnpm install
```
