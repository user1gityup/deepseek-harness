...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'cordis_inspect_self', 'cordis_run', 'cordis_stop', 'cordis_undefine', 'council', 'council_capacity',
      'create_goal', 'edit', 'exit_plan_mode', 'followup_task', 'get_goal', 'glob', 'grep',
      'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list', 'job_output', 'list_agents',
      'list_agents', 'list_providers', 'lsp', 'pipeline', 'propose', 'pwsh', 'pwsh', 'ralph', 'read',
      'read_image', 'report', 'run_code', 'save_pipeline_preset', 'schedule_create', 'schedule_delete',
      ...
      'str_replace_editor', 'subagent', 'swarm', 'team_task_create', 'team_task_get', 'team_task_list',
